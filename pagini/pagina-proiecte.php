					...
					<div class="row">
						<div class="col-md-12">
							<div class="fh5co-blog animate-box">
								<div class="title title-pin text-center">
									<span class="posted-on">Trei editii</span>
									<h3><a href="#">Un proiect</a></h3>
									<span class="category">Scurta descriere</span>
								</div>
								<a href="#"><img class="img-responsive" src="images/proiecte1.jpg" alt=""></a>
						...
						<div class="col-md-6">
							<div class="fh5co-blog animate-box">
								<div class="title text-center">
									...
									<h3><a href="#">Recrutari</a></h3>
									<span class="category">Sunteti bineveniti!</span>
								</div>
								<a href="#"><img class="img-responsive" src="images/proiecte2.jpg" alt=""></a>
								<div class="blog-text text-center">
						...
						<div class="col-md-6">
							<div class="fh5co-blog animate-box">
								<div class="title text-center">
									<span class="posted-on"></span>
									<h3><a href="#">Numele proiectului</a></h3>
